...
class VisionEncoderTrainingConfig(BaseModel):
    ...
    checkpoint_every_n_steps: int | None = Field(250_000, description="Save the model weights every 50_000 steps")

    # Eval the model weights every 50_000 steps
    eval_every_n_steps: int | None = Field(50_000, description="Eval the model weights every 250_000 steps")
