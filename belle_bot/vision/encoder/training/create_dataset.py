...
def create_dataset(subset: Literal["training", "testing"], rgb_pattern: str, depth_pattern: str):
    ...
    print(f"\n{subset} Total items collected: {len(all_items)}. Shuffling...")
    random.shuffle(all_items)

    with wds.ShardWriter(rgb_pattern, maxcount=1000) as rgb_writer, wds.ShardWriter(depth_pattern, maxcount=1000) as depth_writer:
